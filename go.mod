...
replace (
	github.com/longhorn/backing-image-manager => github.com/FrankYang0529/backing-image-manager v0.0.0-20220808083140-bf96e3a05f67
...
require (
	...
	github.com/longhorn/longhorn-instance-manager v0.0.0-20220719082241-1633ac1b6fb0
